...
function LandingPage() {
  return (
    <>
      <SEOHead
        title="Peter's Quest - Start Your Retro Adventure"
        description="Begin your retro adventure with Peter! A unique web game featuring XP progression, mini-games, and retro pixel art. Help Peter solve his problem in this epic quest."
        keywords="Peter's Quest, start game, retro adventure, web game, pixel art, mini-games, XP progression, browser game"
