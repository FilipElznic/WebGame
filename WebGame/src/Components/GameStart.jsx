  ...
  const slides = [
    {
      ...
      description:
        "Join Peter on his quest to complete his homework. Sign up now to save your progress and embark on this epic journey! Discover mysteries, solve puzzles, and help Peter overcome challenges in this retro-style adventure game.",
    },
    {
      title: "Complete his homework",
      description:
        "Peter finds himself stranded on a mysterious island after a shipwreck. With only his wits and determination, he must navigate through dangerous terrain, solve ancient puzzles, and uncover the secrets of this strange land.",
    },
    {
      title: "Adventure Awaits",
      description:
        "Level up your character, collect powerful items, and learn new abilities as you progress. Each challenge overcome makes Peter stronger and brings him closer to completing his ultimate homework assignment.",
    },
    {
      title: "Ready to Play?",
      description:
        "Your adventure awaits! Create an account to save your progress, compete with friends, and become part of Peter's epic journey. The island's mysteries won't solve themselves - are you up for the challenge?",
    },
  ];
