...
function Stage4Page() {
  ...
  const fullText =
    "Nice seeing you again! You are making great progress! Now we need to unlock the chest and see what is inside. (Unlocking chest noises) ... (struggling noises) ... (key breaking noises) ... ... Oh no! The key broke! I guess we need to find another way to open it. Look around and try to find something that can help us. Maybe there is a hidden button or a secret code somewhere?";
